<p align="center">
    ...
    <br />
    <a href="https://github.com/DevelopersToolbox/bash-flock-wrapper/actions/workflows/pipeline.yml">
        <img src="https://img.shields.io/github/workflow/status/DevelopersToolbox/bash-flock-wrapper/pipeline/master?style=for-the-badge" alt="Github Build Status">
    </a>
